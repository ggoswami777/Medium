    ...
    return (
        ...
        <div className='p-4 border-b border-slate-200 pb-4 w-screen max-w-screen-md cursor-pointer'>
            <div className='flex items-center'>
                ...
                <div className='flex justify-center flex-col pl-2 text-slate-500 font-extralight text-sm'>
                    <div className='flex items-center'>
                        <span className='h-1 w-1 rounded-full bg-slate-500 mt-0.5 mx-1'></span>
                        {publishedDate}
                    </div>
                </div>
            </div>
